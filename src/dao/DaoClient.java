...
public class DaoClient {
        ...
        public static void saveEmail(Connection connexion, HashMap<Integer, String> emailMap) throws SQLException, ProjetDaoException {
            ...
            try {
                ...
                if (connexion != null) {
                    try {
                        ...
                        throw new ProjetDaoException("erreur de connexion DAO", 5);
                    }
                }
            } finally {
            ...
            try {
                ...
                if (connexion != null) {
                    try {
                        ...
                        excep.printStackTrace();
                      // ajouter DAO exception avec message approprié
                    }
                }
            } finally {
                if (deleteStmt != null) {
